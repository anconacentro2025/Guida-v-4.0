...
// dalla versione generale della guida.
    ...
    const APP_CACHE_NAME = 'ancona-guida-v6.14-20081000';
...
;
    ...
    function openLightbox(photosCsv){
        ...
        // V6.13: usa fullscreen gallery per i link fotografici
        const linkGalleryIndex = 'link-' + Math.random().toString(36).substr(2,9);
        _detailGalleryData[linkGalleryIndex] = { photos: photos, caption: '' };
